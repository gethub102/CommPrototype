  ...
  class SimpleServer
  {
    ...
    static void Main(string[] args)
    {
      ...
      while(true)
      {
        ...
        Utilities.swapUrls(ref msg); // "fromurl" be changed to "tourl"
        ...
        void test()
        {
            ...
            var record = doc.Descendants("key");
            var record2 = doc.Descendants("element");
            XElement name = new XElement("name");
            var value_of_name = name.Element("name").Value;      
        }
    }
}
